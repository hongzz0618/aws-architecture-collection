...
resource "aws_iam_policy" "lambda_sagemaker_access" {
  name        = "${var.project_name}-${var.environment}-lambda-sagemaker-access"
...
resource "aws_iam_role_policy_attachment" "lambda_sagemaker_access" {
  role       = aws_iam_role.lambda_execution_role.name
  policy_arn = aws_iam_policy.lambda_sagemaker_access.arn
}