...
module "iam" {
  source = "./modules/iam"
  # IAM module outputs roles ARNs used by CodeBuild/CodePipeline/CodeDeploy
...
module "codedeploy" {
  ...
  # targets (autoscaling group name or EC2 tags) should be configured here if you provision ASG/EC2
}
